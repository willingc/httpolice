...
# -*- coding: utf-8 -*-
#
# HTTPolice documentation build configuration file, created by
# sphinx-quickstart on Mon Apr 25 00:44:54 2016.
#
...
htmlhelp_basename = 'HTTPolicedoc'
...
latex_documents = [
    (master_doc, 'HTTPolice.tex', 'HTTPolice Documentation',
     'Vasiliy Faronov', 'manual'),
]
...
man_pages = [
    (master_doc, 'httpolice', 'HTTPolice Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'HTTPolice', 'HTTPolice Documentation',
     author, 'HTTPolice', 'One line description of project.',
     'Miscellaneous'),
]
